    ...
    try {
        ...
        qrcode_1.default.toDataURL(`${config_1.pub}/certificate/${data.certificateNumber}`, { errorCorrectionLevel: "H", width: 500 }, function (_, qr) {
            ...
            pdf
                .fontSize(6)
                .font("Serif-Bold")
                .text(`: ${(0, dayjs_1.default)(data.created).format("DD MMM YYYY")}`, 459, 242);
            pdf
                .fontSize(6)
                .font("Serif-Bold")
            ...
            pdf
                .fontSize(6)
                .font("Serif-Bold")
                .text("UNIT PELAKSANA TEKNIS DAERAH PENGUJIAN DINAS PERHUBUNGAN KOTA TARAKAN", 317, 793, { width: 140 });
            pdf
                .fontSize(6)
                .font("Serif-Italic")
